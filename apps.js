...
window.TOFO_APPS = [
  ...
  },
  {
    ...
    desc: '8×8 の盤に、下に出る 3 つのブロックを好きな順に置き、縦か横の列をうめて消していく。今日の盤は全員に同じ順番でブロックが配られるので、同じ条件でスコアを比べられる。',
    category: 'game',
    tags: ['パズル', '今日の盤'],
    host: 'cloudflare',
    url: 'https://rowbreak.t-of.workers.dev/',
    icon: 'https://rowbreak.t-of.workers.dev/icons/icon-192.png',
    color: '#4bbfa6',
  },
  {
    id: 'lone-deck',
    name: 'LONE DECK',
    title: '必ず解けるひとりトランプ',
    desc: '昔からあるひとりトランプ「ソリティア（クロンダイク）」。配られる札は必ず解ける並びだけで、何手でも戻せる。毎日 1 つの「今日の配り」は誰でも同じ札なので、手数と時間を比べられる。',
    category: 'game',
    tags: ['トランプ', '今日の配り'],
    host: 'cloudflare',
  ...
  },
  {
    ...
    name: 'RINGGRAIN',
    title: '毎日の気分が年輪になる',
    desc: '寝る前に今日の気分を 5 色から 1 つ押すと、切り株の断面の一番外に 1 日ぶんの帯が足される。1 か月で 1 周、1 年で 12 本の年輪になり、その年の気分が 1 枚の絵として残る。',
    category: 'tool',
    tags: ['記録', '毎日'],
    host: 'cloudflare',
    url: 'https://ringgrain.t-of.workers.dev/',
    icon: 'https://ringgrain.t-of.workers.dev/icons/icon-192.png',
    color: '#f4d77a',
  },
  {
    id: 'landing-day',
    name: 'LANDING DAY',
    title: '試験の日に着陸する暗記カード',
    desc: '問題と答えを打って暗記カードを作り、試験の日を決めると、毎日「今日の分」だけ出てくる。上の滑走路のメーターで、今のペースで試験の日に全部覚えて着陸できるかが一目で分かる。',
    category: 'tool',
    tags: ['暗記', '試験'],
    host: 'cloudflare',
    url: 'https://landing-day.t-of.workers.dev/',
    icon: 'https://landing-day.t-of.workers.dev/icons/icon-192.png',
    color: '#ffb84d',
  },
  {
    id: 'pencil-hour',
    name: 'PENCIL HOUR',
    title: '大きな字のプリントを毎日刷る',
    desc: '計算・迷路・数字さがしの大きな字のプリントを、その場で作って A4 1 枚に刷る。「もう 1 枚」を押すたびに違う問題になり、答えの紙も一緒に出る。',
    category: 'tool',
    tags: ['印刷', '大きな字'],
    host: 'cloudflare',
    url: 'https://pencil-hour.t-of.workers.dev/',
    icon: 'https://pencil-hour.t-of.workers.dev/icons/icon-192.png',
    color: '#eb7f45',
  },
  {
    id: 'sestet',
